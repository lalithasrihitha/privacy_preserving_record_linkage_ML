  GNU nano 2.9.8                                              pprl_knn_downsample.py
...
plt.savefig("Knn_downsample_roc.png")
plt.show()
...
plt.savefig("Knn_downsample_pr.png")
plt.show()
...
pd.DataFrame(y_pred).to_csv("knn_downsample_pred.csv", index=False)
