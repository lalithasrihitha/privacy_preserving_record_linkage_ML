  GNU nano 2.9.8                                             pprl_mlnn_downsample.py
...
plt.savefig("MLNN_DOWNSAMPLE_roc.png")
plt.show()
...
plt.title('Precision-Recall Curve - MLNN_DOWNSAMPLE')
plt.savefig("mlnn_downsample_pr.png")
plt.show()
...
pd.DataFrame(y_pred).to_csv("mlnn_downsample_pred.csv", index=False)
