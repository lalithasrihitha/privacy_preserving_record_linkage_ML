  GNU nano 2.9.8                                              pprl_svm_downsample.py
...
plt.savefig("SVM_downsample_roc.png")
plt.show()
...
plt.savefig("SVM_downsample_pr.png")
plt.show()
...
pd.DataFrame(y_pred).to_csv("svm_downsample_pred.csv", index=False)
