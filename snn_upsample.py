  GNU nano 2.9.8                                          pprl_slnn_upsample.py
...
plt.title('ROC Curve - SLNN upsample')
plt.legend(loc="lower right")
plt.savefig("slnn_upsample_roc.png")
plt.show()
...
plt.title('Precision-Recall Curve - SLNN upsample')
plt.savefig("slnn_upsample_pr.png")
plt.show()
...
pd.DataFrame(y_pred).to_csv("slnn_upsample_pred.csv", index=False)
